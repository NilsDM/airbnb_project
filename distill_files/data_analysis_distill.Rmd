...
To get the most common room type available start by selecting `room_type` and `has_availability`, the last one being a logical indicator of general unit availability of room types. Then we filter the rooms that have availability, group them by `room_type` and ranked the room types based.
